                    ...
                    <form action="{{route('work.update,$data->id')}}" method="post">
                        ...
                        <div class="row row-space">
                            ...
                            <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <select name="city_id">
                                            ...
                                            <option value="{{$crow->id}}"@if($data->city_id==$crow->id) selected @endif>{{$crow->city_name}}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <select name="n_id">
                                            <option disabled="disabled" selected="selected">NATIONAL</option>
                                            @foreach($national as $nrow)
                                            <option value="{{$nrow->id}}" @if($data->n_id === $nrow->id) selected @endif>{{$nrow->title_name}}</option>
                                            @endforeach
                                        </select>
                                        <div class="select-dropdown"></div>
                                    </div>
